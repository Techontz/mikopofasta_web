  ...
  return (
    <>
      ...
      <LiveReportPanel
        ...
        note="The legacy screen totalled receivable, received and pending per branch. This is the same question answered from the ledger: what each branch earned, spent and still has on the book."
      />
    </>
  );
}
