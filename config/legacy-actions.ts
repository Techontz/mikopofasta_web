 ...
 * spelling and casing — "Aprove", "Loan Aproved", "Penarty", "Loan fee".
 *
...
export const LEGACY_ACTIONS: LegacyAction[] = [
  ...
  { label: "Teller", href: "/repayments/cash-entry", icon: HandCoins, color: "#e2703a", permission: PERMISSIONS.REPAYMENTS_CASH_ENTRY },
  { label: "Receivable", href: "/repayments", icon: Receipt, color: "#6ab04c", permission: PERMISSIONS.REPAYMENTS_VIEW },
  { label: "Received", href: "/repayments", icon: MailCheck, color: "#27ae60", permission: PERMISSIONS.REPAYMENTS_VIEW },
  ...
  { label: "Loan Aproved", href: "/loans", icon: CircleCheckBig, color: "#27ae60", permission: PERMISSIONS.LOANS_VIEW },
  { label: "Penarty", href: null, icon: Gavel, color: "#8d6e63" },
  ...
  { label: "Cash Transaction", href: "/repayments/cash-entry", icon: FileStack, color: "#5b8def", permission: PERMISSIONS.REPAYMENTS_CASH_ENTRY },
